...
import org.mnilsen.weather.core.Stations;

public class Bme280Device {
    public Bme280Device() {
        super();
    }
    
    public Reading takeReading() throws UnsupportedBusNumberException, IOException {
        ...
        long adc_p =
            (((long) (data[0] & 0xFF) * 65536) + ((long) (data[1] & 0xFF) * 256) + (long) (data[2] & 0xF0)) / 16;
        long adc_t =
            (((long) (data[3] & 0xFF) * 65536) + ((long) (data[4] & 0xFF) * 256) + (long) (data[5] & 0xF0)) / 16;
        ...
        var_H =
            (adc_h - (dig_H4 * 64.0 + dig_H5 / 16384.0 * var_H)) *
...
//        System.out.printf("Time : %s %n", new Date());
//        System.out.printf("Temperature in Celsius : %.2f C %n", cTemp);
//        System.out.printf("Temperature in Fahrenheit : %.2f F %n", fTemp);
//        System.out.printf("Pressure : %.2f hPa %n", pressure);
//        System.out.printf("Relative Humidity : %.2f %% RH %n", humidity);
//        System.out.println();
        reading = new Reading(Stations.getStationForId(1),System.currentTimeMillis(),cTemp,fTemp,pressure,humidity);
        return reading;
    }
}
